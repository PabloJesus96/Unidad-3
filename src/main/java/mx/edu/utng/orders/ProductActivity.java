...
public class ProductActivity extends AppCompatActivity {
    ...
    private void initComponents(){
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.bt_delete_product:
                        operations.deleteProduct(products.get(rvProducts.getChildPosition(
                    ...
                    case R.id.bt_edit_product:
                        ...
                        Cursor c = operations.getProductById(products.get(rvProducts.getChildPosition(
                                (View)v.getParent().getParent())).getIdProduct());
                        ...
                        if(c!=null){
                            if(c.moveToFirst()){
                                ...
                                Toast.makeText(ProductActivity.this, "Registro no encontrado", Toast.LENGTH_SHORT).show();
                            }
                        }
                        break;
                    default:
        ...
        btSaveProduct =(Button)findViewById(R.id.bt_save_prodcut);
            ...
            public void onClick(View v) {
               if(!product.getIdProduct().equals("")){
                   ...
                   product = new Product("", etName.getText().toString(),
                           Float.parseFloat(etStock.getText().toString()),
